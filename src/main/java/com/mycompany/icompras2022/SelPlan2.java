            ...
            if (miConexion != null) {
                try {
                    ...
                    while (miResultset.next()) {
                        String CodProd = miResultset.getString("CODIGO");
                        String DesProd = miResultset.getString("NOMBRE");
        ...
        try {
            ...
            if (miConexion != null) {
                try {
                    ...
                    String instruccionSql = "SELECT * FROM [valyval].[dbo].[PLAN_DB] WHERE NIVEL1=4 ";
                    miStatement = miConexion.createStatement();
                    miResultset = miStatement.executeQuery(instruccionSql);
                    String nombre = "";
